...
UPlayerFire::UPlayerFire()
{
	...
	// 총알 공장 가져오기
	ConstructorHelpers::FClassFinder<ABullet> tempBullet(TEXT("Blueprint'/Game/_My/Blueprints/BP_Bullet.BP_Bullet_C'"));
	if (tempBullet.Succeeded())
	{
		bulletFactory = tempBullet.Class;
	}
	// SniperUI 가져오기
	ConstructorHelpers::FClassFinder<UUserWidget> tempSnierWidget(TEXT("WidgetBlueprint'/Game/_My/Blueprints/WBP_SniperUI.WBP_SniperUI_C'"));
	if (tempSnierWidget.Succeeded())
	{
		sniperUIFactory = tempSnierWidget.Class;
	}
	// Crosshair UI 가져오기
	ConstructorHelpers::FClassFinder<UUserWidget> tempCrosshairWidget(TEXT("WidgetBlueprint'/Game/_My/Blueprints/WBP_Crosshair.WBP_Crosshair_C'"));
	...
	// Camera Shake 가져오기
	ConstructorHelpers::FClassFinder<UCameraShakeBase> tempCameraShake(TEXT("Blueprint'/Game/_My/Blueprints/BP_CameraShake.BP_CameraShake_C'"));
